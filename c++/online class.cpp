...
public:
    ...
    void print_e_mark()
    {
        cout<<"Your Mid Term Mark is: "<<mid<<endl;
        cout<<"Your Final Term Mark is: "<<final_exam<<endl;
    }
};
...
public:
    ...
    void print_c_mark()
    {
        cout<<"Your Attendance mark: "<<att<<endl;
        cout<<"Your Class Test mark: "<<test<<endl;
